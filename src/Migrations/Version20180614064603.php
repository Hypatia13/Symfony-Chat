 ...
 */
final class Version20180614064603 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chat_users (id INTEGER NOT NULL, username VARCHAR(25) NOT NULL COLLATE BINARY, email VARCHAR(254) NOT NULL COLLATE BINARY, password VARCHAR(64) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , is_moderator BOOLEAN NOT NULL, is_admin BOOLEAN NOT NULL, PRIMARY KEY(id))');
